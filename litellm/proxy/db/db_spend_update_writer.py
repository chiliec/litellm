...
class DBSpendUpdateWriter:
    ...
    async def _update_org_db(
        ...
        try:
            ...
            try:
                ...
                spend_log_error(
                    "Spend tracking - failed to enqueue organization member spend update. "
                    "org_id=%s, user_id=%s, response_cost=%s - %s",
                    org_id,
                    user_id,
                    response_cost,
                    str(e),
    ...
    async def _commit_spend_updates_to_db(
        ...
        ### UPDATE ORG Membership TABLE ###
        org_member_list_transactions: Final = db_spend_update_transactions["org_member_list_transactions"]
