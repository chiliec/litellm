  ...
  return (
    <>
      ...
      <p className="text-xs text-muted-foreground">
        ...
        account for matching cache prefixes and expiry. Total actual spend includes every turn; savings and baseline
        spend include only turns with a current estimate. Savings are net of recorded LLM classification cost.
